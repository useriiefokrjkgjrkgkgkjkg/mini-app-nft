    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <nav className="w-full bg-[#17181C] py-2 px-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill={activeTab === 'gallery' ? "#00A3FF" : "#8B8B8B"}>
            ...
            <span className={activeTab === 'gallery' ? "text-[#00A3FF] text-xs" : "text-[#8B8B8B] text-xs"}>Gallery</span>
          </button>
